    ...
    <el-form label-position="top" label-width="80px" :model="formdata">
      ...
      <el-tabs tab-position="left" v-model="active" class="alert" :before-leave="handleChangeTabs" @tab-click="handleTabs">
        ...
        <el-tab-pane label="商品图片" name="4">
          <!-- 文件上传 -->
          <el-upload action="http://175.27.228.178:3434/api/private/v1/upload" list-type="picture-card" :headers="tokenHeader" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload" :on-remove="handleRemove">
